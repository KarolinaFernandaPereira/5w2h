...
function openModalToView(id) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.tarefa.funcionario.length != 0) {
                response.tarefa.funcionario.forEach(function (membro) {
                    console.log(membro)
                    var membro = ` <div class="membroAdicionado" style="display: flex;
                    ...
                    $membrosTarefa.innerHTML += membro;
                })
            } else {
